...
\begin{lem}[DFA$_{\text{min}}$]{minDFA}
    Als een DFA N = $(Q_1,\Sigma, \delta_1, q_s, F_1)$  een DFA is zonder onbereikbare toestanden en waarin elke twee toestanden $f$-verschillend zijn, 
...
\begin{theo}[DFA isomorfisme]{DFA isomorfisme}
    Een DFA$_1 = (Q_1,\Sigma, \delta_1, q_{s_1}, F_1)$ is \textbf{isomorf} met een DFA$_2 = (Q_2,\Sigma, \delta_2, q_{s_2}, F_2)$ als er een bijectie $b: Q_1 \to Q_2$ bestaat zodanig dat
    \begin{itemize}
        \item $b(F_1) = F_2$
